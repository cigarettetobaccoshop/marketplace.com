...
var ASSETS = {
  ...
  preview: 'assets/logo/preview.jpg',
  footerBg: 'assets/logo/footer-bg.jpg',
  watermark: 'assets/logo/watermark.png',
  loaderBg: 'assets/logo/loader-bg.jpg',
  heroBg: 'assets/logo/hero-bg.jpg'
};
...
function initHeader() {
  ...
  if (!header) return;
  window.addEventListener('scroll', function() {
    if (window.scrollY > 80) header.classList.add('scrolled', 'header-scrolled');
    else header.classList.remove('scrolled', 'header-scrolled');
  });
